...
Specialized skill for **evolution** operations in multi-agent environments (OpenClaw/KiloCode).

## Overview

Genome Weaver helps execute evolution tasks with a secure, repeatable, and audit-friendly workflow.

## When to use

- You need structured execution in the **evolution** domain.
- You want reproducible outputs (plan, verification, rollback).
- You need explicit safety guardrails and operator control.

## Core capabilities

- Trigger-based activation for evolution scenarios.
...
**Input:** "Audit and improve evolution workflow."
